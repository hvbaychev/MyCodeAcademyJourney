...
function generate_month_calendar($date, $firstDayOfWeek = "", $includePreviousDays = false, $zodiac) {
...
generate_month_calendar(date("2023-05-16"), $firstDayOfMonth = "П", $includePreviousDays = true, $zodiac = []);
